            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="small text-muted">
                        ...
                        <li><strong>InvNo</strong> - Invoice Number (Required, integer only, 0 allowed)</li>
                        <li><strong>InvDate</strong> - Invoice Date (Required, date format)</li>
                        <li><strong>MAGICH</strong> - Magic ID (Required, numeric)</li>
                        <li><strong>DocType</strong> - Document Type (Required, I=Invoice or C=Credit Note)</li>
                        <li><strong>ExchangeRate</strong> - Exchange Rate (Optional, numeric/decimal)</li>
                        <li><strong>RegNo</strong> - Registration Number (Optional, max 20 chars)</li>
                        <li><strong>Chassis</strong> - Chassis Number (Optional, max 25 chars)</li>
                        <li><strong>Mileage</strong> - Mileage (Required, numeric, 0 allowed)</li>
                        <li><strong>CurrCode</strong> - Currency Code (Required, max 3 chars)</li>
                        <li><strong>GrossValue</strong> - Gross Value (Optional, numeric/decimal)</li>
                        <li><strong>NetValue</strong> - Net Value (Optional, numeric/decimal)</li>
                        <li><strong>CustDisc</strong> - Customer Discount (Optional, max 10 chars)</li>
                        <li><strong>SvcCode</strong> - Service Code (Optional, max 3 chars)</li>
                        <li><strong>RegDate</strong> - Registration Date (Optional, date format)</li>
                        <li><strong>Description</strong> - Description (Optional, max 250 chars)</li>
                        <li><strong>EngineNo</strong> - Engine Number (Optional, max 20 chars)</li>
                        <li><strong>P1</strong> - Phone Number 1 (Optional, numeric only, max 20 chars)</li>
                        <li><strong>P2</strong> - Phone Number 2 (Optional, numeric only, max 20 chars)</li>
                        <li><strong>P3</strong> - Phone Number 3 (Optional, numeric only, max 20 chars)</li>
                        <li><strong>P4</strong> - Phone Number 4 (Optional, numeric only, max 20 chars)</li>
                        <li><strong>Oper</strong> - Operator Code (Optional, alphanumeric, max 20 chars)</li>
                        <li><strong>OperName</strong> - Operator Name (Optional, text, max 150 chars)</li>
                        <li><strong>AccCo</strong> - Account Company (Required, alphanumeric, max 50 chars)</li>
                        <li><strong>PosCo</strong> - POS Code (Required, alphanumeric, max 20 chars)</li>
                    </ul>

                    <h6 class="mt-3">Notes</h6>
                    <ul class="small text-muted">
                        <li>The import uses <strong>update data</strong> based on WIPNO, InvNo, PosCo and MAGICH</li>
